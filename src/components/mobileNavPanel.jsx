...
import { MdPhotoLibrary, MdContacts, MdInfoOutline, MdLogin, MdLogout } from "react-icons/md";
			...
			{isOpen && (
				<div className="w-full h-screen bg-[#00000070] fixed top-0 left-0 z-50">
					<div className="h-full bg-white w-[300px] shadow-lg">
						...
						{token!=null&&<div className="text-[20px] text-accent m-1 p-2 flex items-center gap-2 cursor-pointer hover:bg-accent/10 rounded-md" onClick={()=>{
